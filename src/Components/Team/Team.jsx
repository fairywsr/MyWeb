...
const questions = [
  {
    id: 1,
    title: "Question about Livewire Rendering and Alpine JS",
  ...
  return (
    <>
      {questions.map((question) => (
        <article key={question.id} className="rounded-xl border-2 border-gray-100 bg-white mx-40">
          <div className="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
            ...
            <div>
              <h3 className="font-medium sm:text-lg">
                <a href="#" className="hover:underline">{question.title}</a>
              </h3>
              <p className="line-clamp-2 text-sm text-gray-700">{question.description}</p>
              <div className="mt-2 sm:flex sm:items-center sm:gap-2">
                <div className="flex items-center gap-1 text-gray-500">
                  ...
                  <p className="text-xs">{question.comments} comments</p>
                </div>
                <span className="hidden sm:block" aria-hidden="true">&middot;</span>
                <p className="hidden sm:block sm:text-xs sm:text-gray-500">
                  Posted by
                  <a href="#" className="font-medium underline hover:text-gray-700"> {question.postedBy} </a>
                </p>
              </div>
            </div>
          </div>
